...
def build_think_query(user_query):
    ...
    return (
        "You are in THINK MODE for a Quantum Qumi.\n\n"
...
st.caption(
    "Interactive Qumi for Quantum Computing & Advanced Physics"
)
